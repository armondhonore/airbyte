...
**Live:** [https://relaxed-weasel-airbyte.cloud.nexlayer.ai](https://relaxed-weasel-airbyte.cloud.nexlayer.ai)  
...
**airbyte** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/airbyte/webapp:latest
    path: /
    servicePorts:
    - 8080
    vars:
      ...
      API_URL: "/api/v1/"
      INTERNAL_API_HOST: "server.pod:8001"
```
